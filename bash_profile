...
showcolors() {
    ...
    echo
    echo '\\033[38;5;${color_number}m'
    echo 'or use the color function with the number then the text'
}
color() {
    txt=${@:2}
    echo -e "\\033[38;5;${1:-166}m${txt:-Example}\\033[0m"
}
alias echoc="color"
